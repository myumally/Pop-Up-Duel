...
std::array<int, 34> RedShield = { 8, 9, 10, 13, 25, 26, 50, 51, 52, 53, 54, 59, 60, 61, 62, 65, 66, 67, 68, 70, 72, 75, 76, 82, 91, 92, 95, 96, 101, 106, 112, 114, 116 };

std::array<int, 34> GreenShield = { 1, 3, 4, 5, 7, 8, 9, 13, 15, 16, 17, 18, 19, 20, 21, 23, 24, 25, 26, 27, 28, 30, 34, 39, 40, 57, 58, 59, 65, 66, 67, 98, 108, 109, 117 };
